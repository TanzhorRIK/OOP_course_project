...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tanzh\py_project\OOP_course_project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tanzh\py_project\OOP_course_project\venv\Scripts\deactivate.nu'
